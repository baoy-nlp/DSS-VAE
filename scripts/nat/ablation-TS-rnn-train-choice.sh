...
--exp_desc ablation-pos${1}_${2}-rnn-step${3} \
--pos_pred_type ${1} --pos_predict_scale ${2} --content_scale 0.0 \
--pos_search_type 0 --pos_learn_embed \
--join_train_steps ${3} \
...
--layer_weight 0 0 --content_loss_type l2r_prior --pos_index_state \
...
--pos_enc_cls rnn --share_vocab --share_embed


"""
ablation study: for predictor Type and correspond update Scale

sh ablation-TS.sh 4 0.1
