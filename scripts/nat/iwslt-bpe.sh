...
MT_Tgt_DIR=/mnt/cephfs_wj/common/lab/baoyu.nlp/data/iwslt/bpe_level

mkdir ${MT_Tgt_DIR}

cp ${MT_Ori_DIR}/train/train.tags.en-de.bpe.en ${MT_Tgt_DIR}/train.en.token.lower
cp ${MT_Ori_DIR}/train/train.tags.en-de.bpe.de ${MT_Tgt_DIR}/train.de.token.lower
cp ${MT_Ori_DIR}/dev/valid.en-de.bpe.en ${MT_Tgt_DIR}/valid.en.token.lower
cp ${MT_Ori_DIR}/dev/valid.en-de.bpe.de ${MT_Tgt_DIR}/valid.de.token.lower
